...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaHourglassHalf, FaMoneyBillAlt, FaMoneyBillWaveAlt, FaTimesCircle, FaUsers } from 'react-icons/fa';
  ...
  return (
    <div className='p-6'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6" >
            ...
            <SummaryCard icon={<FaBuilding />} text="Total sellers" number= {5} color="bg-yellow-600"/>
            <SummaryCard icon={<FaMoneyBillWaveAlt/>} text="Monthly Salary" number= "$654" color="bg-red-600"/>
        </div>
        <div className="mt-12" >
